import { TimeClass, Title, Variant } from '@chess.com/generated/prisma/client';
import { useQuery } from '@chess.com/hooks/use-query-param';
...
export const InsightsHeader: React.FC<InsightsHeaderProperties> = ({
	...
	const { value: timeClass, setValue: setTimeClass } = useQuery(
		'timeClass',
		TimeClass.blitz,
	);
	const { value: variant, setValue: setVariant } = useQuery(
		'variant',
		Variant.chess,
	);
