import { COLORS_MAP } from '@chess.com/constants/chess.constants';
import { Insights, Result } from '@chess.com/services/insights/insights.dto';
import { customLabel } from '@chess.com/utils/tests/custom-label';
