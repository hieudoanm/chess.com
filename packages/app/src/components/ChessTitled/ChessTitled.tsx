import { Maps } from '@chess.com/components/Maps';
import { QueryTemplate } from '@chess.com/components/QueryTemplate';
import { Title } from '@chess.com/generated/prisma/client';
import countries from '@chess.com/json/countries.json';
import maps from '@chess.com/json/world.json';
import { Days } from '@chess.com/services/insights/insights.service';
import { trpc } from '@chess.com/utils/trpc';
						...
						<div className="flex items-center justify-between">
							...
							<div className="join rounded-xl">
								...
								<button
									...
									onClick={() => setState({ ...state, countriesView: 'maps' })}>
									Maps
								</button>
							</div>
						</div>
							...
							<div className="card">
								<div className="card-body">
									<div className="flex items-center gap-x-4 md:gap-x-8">
										<div className="grow">
											<Maps id="world" svg={maps} data={countriesData} />
										</div>
