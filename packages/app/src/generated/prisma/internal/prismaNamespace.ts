...
> = {
	...
	meta: {
		modelProps: 'player' | 'game' | 'opening' | 'country';
		...
		Opening: {
			...
			operations: {
				...
				count: {
					...
					result:
						| runtime.Types.Utils.Optional<Prisma.OpeningCountAggregateOutputType>
						| number;
				};
			};
		};
...
export type OpeningScalarFieldEnum =
	(typeof OpeningScalarFieldEnum)[keyof typeof OpeningScalarFieldEnum];
 ...
 */
export type EnumTitleFieldRefInput<$PrismaModel> = FieldRefInputType<
	$PrismaModel,
	'Title'
>;
 ...
 */
export type EnumVariantFieldRefInput<$PrismaModel> = FieldRefInputType<
	$PrismaModel,
	'Variant'
>;
...
/**
 * Reference to a field of type 'Phrase'
 */
export type EnumPhraseFieldRefInput<$PrismaModel> = FieldRefInputType<
	$PrismaModel,
	'Phrase'
>;
